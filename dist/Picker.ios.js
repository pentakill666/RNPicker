        ...
        return (
            <View style={styles.container}>
                <Modal
                  ...
                  >
                  <TouchableOpacity style={styles.wrap} activeOpacity={1} onPress={()=>this._cancel()}>
                    <View style={styles.pickerWrap}>
                        ...
                        onValueChange={(itemValue,itemIndex) =>this.setState({selectedValue:itemValue,currentLabel:data[itemIndex].name})}>
